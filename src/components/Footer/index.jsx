            ...
            <div className="w-full bg-[#D6C8AE] h-auto lg:h-96 relative lg:py-16 lg:px-20 md:py-8 md:px-10 py-6 px-6 overflow-hidden bg-[url('/PatternFooter.svg')] bg-repeat bg-cover md:bg-contain flex flex-col justify-between">
                <div className="flex md:gap-6 flex-col lg:flex-row">
                    <div className="flex flex-col gap-4">
                        <img
                            src="/Leveluplandscape.svg"
                            alt="Logo LevelUp"
                            width={200}
                            className="lg:w-48 w-40"
                        />
                        <p className="text-[#916D4F] font-roboto italic md:text-sm text-[0.8rem]">
                            “ Lorem ipsum dolor sit amet consectetur adipisicing
                            elit. Laborum, necessitatibus nemo. Expedita alias
                            natus impedit tempora quaerat, exercitationem
                            pariatur ipsam qui quidem ad odio est. “
                        </p>
                    </div>
                    <div className="flex flex-wrap md:flex-nowrap justify-between">
                        <div className="w-36 mt-6 md:mt-0">
                            <h1 className="font-roboto font-medium text-[#916D4F] text-lg mb-4">
                                Information
                            </h1>
                            <div className="flex flex-col font-roboto font-light gap-2 text-sm text-[#916D4F]">
                        ...
                        <div className="w-36 mt-6 md:mt-0">
                            ...
                            <div className="flex flex-col font-roboto font-light gap-2 text-sm text-[#916D4F]">
                                ...
                                <a href="#" className="hover:text-white">
                                    info@levelupbeaute.id
                                </a>
                            </div>
                        </div>
                    </div>
                </div>
                <div className="flex justify-between items-center flex-col md:flex-row mt-6 lg:mt-0 gap-4 md:gap-0">
                    <div>
                    ...
                    <div>
                        <h1 className="text-[#916D4F] font-roboto italic text-xs font-light text-center md:text-end">
                            All Rights Reserved ©2024 Level Up Beaute. Part of
                            SS Group
                        </h1>
                    </div>
                </div>
